...
export class UserServerController extends CRUDServerController<Record<string, any>, Record<string, any>> {
    ...
    @UsePipes(QueryPipe)
    getUserServerList(@GetUser() currentUser: CurrentUser, @Query() query: PaginationQueryDto, @Req() request: Request) {
    ...
    getUserServerById(@GetUser() currentUser: CurrentUser, @Param('id', ParseIntPipe) id: number, @Query() query: PaginationQueryDto, @Req() request: Request) {
    ...
    postUserServer(@GetUser() currentUser: CurrentUser, @Query() query: PaginationQueryDto, @Body() dto: Record<string, any>, @Req() request: Request) {
    ...
    deleteUserServerId(@GetUser() currentUser: CurrentUser, @Param('id', ParseIntPipe) id: number, @Query() query: PaginationQueryDto, @Req() request: Request) {
